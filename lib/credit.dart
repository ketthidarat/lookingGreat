...
class _SignUpFormState extends State<SignUpForm> {  
  ...
  void loadtype() {
    ...
    typeList = [];
    new Text('วันหมดอายุของการ์ด');
    typeList.add(new DropdownMenuItem(
      
      child: new Text('วันหมดอายุของการ์ด'),
      value: 0,
    ));
    typeList.add(new DropdownMenuItem(
  ...
  formWidget.add(new TextFormField(
      decoration: InputDecoration(hintText: 'ชื่อ-สกุล (บนการ์ด)', labelText: 'ชื่อ - สกุล (บนการ์ด)'),
      keyboardType: TextInputType.text,
      validator: (value) {
        if (value.isEmpty) return 'ชื่อ - สกุล (บนการ์ด)';
      },
      onSaved: (value) {
        setState(() {
          _name1 = value;
  ...
  formWidget.add(new TextFormField(
      decoration: InputDecoration(hintText: 'เลขบนการ์ด', labelText: 'เลขบนการ์ด'),
      keyboardType: TextInputType.text,
      validator: (value) {
        if (value.isEmpty) return 'เลขบนการ์ด';
      },
      onSaved: (value) {
        setState(() {
          _lastname1 = value;
