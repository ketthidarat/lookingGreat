...
void onPressedSubmit() {
  ...
  formWidget.add(new TextFormField(
    ...
    formWidget.add(new TextFormField(
      ...
      decoration: InputDecoration(hintText: 'ที่อยู่ร้านค้า', labelText: 'ที่อยู่ร้านค้า'),
      keyboardType: TextInputType.text,
      validator: (value) {
        if (value.isEmpty) return 'ที่อยู่ร้านค้า';
      },
      onSaved: (value) {
        setState(() {
          _idme = value;
    ...
    formWidget.add(new TextFormField(
      decoration: InputDecoration(hintText: 'เบอร์ติดต่อ', labelText: 'เบอร์ติดต่อ'),
      keyboardType: TextInputType.text,
      validator: (value) {
        if (value.isEmpty) return 'เบอร์ติดต่อ';
      },
      onSaved: (value) {
        setState(() {
          _idme = value;
    ...
    formWidget.add(new TextFormField(
      decoration: InputDecoration(hintText: 'Facebook', labelText: 'Facebook'),
      keyboardType: TextInputType.text,
      validator: (value) {
        if (value.isEmpty) return 'Facebook';
      },
      onSaved: (value) {
        setState(() {
          _idme = value;
